...
public class CommonExceptionHandler {
    ...
    private ErrorType mapErrorType(Exception exception) {
        ...
        if (exception instanceof WordNotFoundException) return ErrorType.WORD_NOT_FOUND;
        if (exception instanceof WordAlreadyInSetException) return ErrorType.WORD_IS_ALREADY_IN_SET;
